						...
						<td class='movableContentContainer'>
										...
										<td width="200" valign="top" align="center">
											<div class="contentEditableContainer contentTextEditable">
												<div class="contentEditable" >
													<img src="{{url('/public/upload/images')}}/{{$settings->logo }}" width="155" height='155' alt='Logo'  data-default="placeholder" />
												</div>
											</div>
										</td>
										<td width="200" valign="top">&nbsp;</td>
								...
								<table cellpadding="0" cellspacing="0" border="0" align="center" width="600">
									...
									<tr>
										...
										<td width="400" align="center" style="padding-bottom:5px;">
											<div class="contentEditableContainer contentTextEditable">
												<div class="contentEditable" >
													<h4>[DEVWORK.VN] | HỆ THỐNG TUYỂN DỤNG IT CHẤT LƯỢNG</h4>
												</div>
											</div>
										</td>
										<td width="100">&nbsp;</td>
							...
							<div class='movableContent'>
								<table cellpadding="0" cellspacing="0" border="0" align="center" width="600">
									<tr>
										<td width="100">&nbsp;</td>
										<td width="400" align="center" style="padding-top:25px;padding-bottom:15px;">
											<table cellpadding="0" cellspacing="0" border="0" align="center" width="200" height="50">
												<tr>
													<td bgcolor="#ED006F" align="center" style="border-radius:4px;" width="200" height="50">
														<div class="contentEditableContainer contentTextEditable">
															<div class="contentEditable" >
																<a target='_blank' href="{{ url('/') }}" class='link2'>Visit our Website</a>
															</div>
														</div>
											...
											<table cellpadding="0" style="border-collapse:collapse;" cellspacing="0" border="0" align="center" width="600">
												<tr>
														...
														<div class="contentEditableContainer contentImageEditable">
															<div class="contentEditable" >
																<div style="padding-top:20px;text-align:center;">
																	<img src="{{url('/public/images')}}/6@2x.png" width="148" data-default="placeholder" data-max-width="200" style="margin-bottom:-3px;" />
																</div>
															</div>
														</div>
													...
													<td width="400" valign="top" style="padding-top:40px;padding-bottom:20px;">
														...
														<div class="contentEditableContainer contentTextEditable">
															<div class="contentEditable" >
																<div style="font-size:23px;font-family:Heveltica, Arial, sans-serif;color:#fff;height: auto;width: 100%;">{{ $data->title }}</div>
															</div>
														</div>
														...
														<div class="contentEditableContainer contentTextEditable">
															<div class="contentEditable"  style="padding:20px 10px 0 0;margin:0;font-family:Helvetica, Arial, sans-serif;font-size:15px;line-height:150%;">
																<p style='color:#FFEECE;'>{{ $data->content }}</p>
															</div>
														</div>
								...
								<table cellpadding="0" cellspacing="0" border="0" align="center" width="600">
									...
									<tr>
										...
										<td width="500" align="left">
											<div class="contentEditableContainer contentTextEditable">
												<div class="contentEditable" >
													<div style="font-family:Helvetica, Arial, sans-serif;font-size:16px;line-height:160%;color:#181818;font-weight:bold;">{{ $data->body }}</div>
												</div>
											</div>
											<div style="height:20px;">&nbsp;</div>
											<div class="contentEditableContainer contentTextEditable">
												<div class="contentEditable" >
													<p >Mọi thông tin hỗ trợ, Quý công ty có thể liên hệ</p>
													<p> Contact name: {{ $data->contact_name }} </p>
													<p> SĐT: {{ $data->contact_phone }} </p>
								...
								<table cellpadding="0" cellspacing="0" border="0" align="center" width="600">
									<tr>
										<td width="100%" align="center" style="padding-bottom:10px;padding-top:100px;">
											<div class="contentEditableContainer contentTextEditable">
												<div class="contentEditable" style="width:  100%;float:  left;height:  auto;">
													<h2>CHÚNG TÔI MANG ĐẾN SỰ TIN CẬY CHO CÁC BẠN</h2>
												</div>
											</div>
										</td>
									</tr>
									<tr>
										<td width="100%" align="center">
											<div class="contentEditableContainer contentTextEditable">
												<div class="contentEditable" >
													<p >Chúng tôi xây dựng phát triển nghành IT hàng đầu việt nam</p>
												</div>
											</div>
										</td>
									</tr>
												...
												<tr>
													<td width="600" valign="top">
														<div style="text-align:center;margin-bottom:-3px;">
															<div class="contentEditableContainer contentImageEditable">
																<div class="contentEditable" >
																	<img src="{{url('/public/images')}}//pics.png" width="600" alt='design images'  data-default="placeholder" data-max-width="600" />
																</div>
															</div>
														</div>
													</td>
								...
								<table cellpadding="0" cellspacing="0" border="0" align="center" width="600">
									<tr>
										<td width="100%" align="center" style="padding-bottom:10px;padding-top:100px;">
											<div class="contentEditableContainer contentTextEditable">
												<div class="contentEditable" style="width:  100%;float:  left;height:  auto;">
													<h2>CHÚNG TÔI LUÔN ĐỒNG HÀNH CÙNG CÁC BẠN</h2>
												</div>
											</div>
										</td>
									</tr>
									<tr>
										<td width="100%" align="center">
											<div class="contentEditableContainer contentTextEditable">
												<div class="contentEditable" >
													<p >Các bạn cảm thấy tuyển dụng IT khó thì đã có chúng tôi
													</p>
												</div>
											</div>
										</td>
										...
										<td width="100%" align="center">
											<div class="contentEditableContainer contentImageEditable" style="display:inline;">
												<div class="contentEditable" style="display:inline;">
													<img src="{{url('/public/images')}}/yes.gif" width="200"  alt='yes'  data-default="placeholder" data-max-width="200" style='padding-right:10px;'/>
												</div>
											</div>
											<div class="contentEditableContainer contentImageEditable" style="display:inline;">
												<div class="contentEditable" style="display:inline;">
													<img src="{{url('/public/images')}}/no.gif" width="200"  alt='no'  data-default="placeholder" data-max-width="200" style='padding-left:10px;'/>
												</div>
											</div>
										</td>
									</tr>
								...
								<table cellpadding="0" cellspacing="0" border="0" align="center" width="600">
									...
									<tr>
										<td width="60%" height="70" valign="middle" style="padding-bottom:20px;">
											<div class="contentEditableContainer contentTextEditable">
												<div class="contentEditable" >
													<span style="font-size:13px;color:#181818;font-family:Helvetica, Arial, sans-serif;line-height:200%;">Guwit từ [email] by [CLIENTS.COMPANY_NAME]</span>
													<br/>
												...
												<tr>
													...
													<td valign="top" width='34'>
														<div class="contentEditableContainer contentFacebookEditable" style='display:inline;'>
															<div class="contentEditable" >
																<img src="{{url('/public/images')}}/facebook.png" data-default="placeholder" data-max-width="30" width='30' height='30' alt='facebook' style='margin-right:40x;' data-customIcon="true" >
															</div>
														</div>
													</td>
													<td valign="top" width='34'>
														<div class="contentEditableContainer contentTwitterEditable" style='display:inline;'>
															<div class="contentEditable" >
																<img src="{{url('/public/images')}}/twitter.png" data-default="placeholder" data-max-width="30" width='30' height='30' alt='twitter' style='margin-right:40x;' data-customIcon="true" >
															</div>
														</div>
													</td>
													<td valign="top" width='34'>
														<div class="contentEditableContainer contentImageEditable" style='display:inline;'>
															<div class="contentEditable" >
																<a target='_blank' href="#" data-default="placeholder"  style="text-decoration:none;">
																	<img src="{{url('/public/images')}}/pinterest.png" width="30" height="30" data-max-width="30" alt='pinterest' style='margin-right:40x;' />
																</a>
															</div>
														</div>
													</td>
