              ...
              <div class="card-body">
                <div class="row">
                  ...
                  <div class="col-md-12">
                    <div class="form-group">
                      <div class="form-field">
                        <input type="button" :value="$t('banner.search')" data-toggle="tooltip" data-placement="top" title="Tìm Ngay" class="form-control col-md-12 btn bg-netbee bg-black" @click="search">
                      </div>
                    </div>
                  </div>
                </div>
