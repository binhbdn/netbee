<template>
    <div>
        <section class="ftco-section bg-white category pt-0" style="">
            <div class="container">
                    ...
                    <div class="col-4">
                        <div class="card">
                            ...
                            <div class="card-content collapse show">
                                <div class="card-body">
                                    <div class="row">
                                        <div  class=" p-2 bg-white col-12" id="cate-1" style="border-bottom: 1px solid #ddd;">
                                            <div class="col-12">
                                                <div class="job-post-item-header d-flex align-items-center">
                                                    <a href="#">
                                                        <h2 class="mr-3 text-black h6 NB_title" ><i class="fa fa-arrow-right"></i>Tuyển lập trình viên PHP</h2>
                                                    </a>
                                                </div>
                                            </div>
                                        </div>
