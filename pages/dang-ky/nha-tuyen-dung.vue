<template>
    ...
    <div class="container">
        <div class="row ">
            <div class="intro-netbee col-md-7 col-sm-12 content-left">
            ...
            <div class="col-md-5 col-sm-12 content-right" style="padding:0px 15px; ">
                ...
                <form method="POST" class="appointment-form" id="appointment-form-2" style="margin-top:10px;" v-on:keyup.enter="signIn">
                        ...
                        <div class="form-group" style="margin-bottom:0px;">
                            <label for="exampleInputEmail1" style="margin-bottom: 5px;" class="text-register">Tên công ty (<span style="color: red; font-size: 20px;">*</span>)</label>
