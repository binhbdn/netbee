    ...
    <div class="container">
        <div class="row ">
            ...
            <div class="col-5" style="padding:0px 15px; ">
                ...
                <form method="POST" class="appointment-form" id="appointment-form-3" style="margin-top:10px">
                    ...
                    <div class="form-submit text-center" style="padding-bottom: 10px; padding-top:10px;">
