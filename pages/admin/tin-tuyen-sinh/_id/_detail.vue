                                    ...
                                    <div class="row p-1">
                                        ...
                                        <div class="col-lg-7">
                                            <div class="company-job-title resp-text">
                                                ...
                                                <p v-else><span class="font-weight-600">Chi phí xuất cảnh:</span> {{ FormatPrice(tintuyendung.subsidy) }}</p>
                                        ...
                                        <div class="col-lg-3 resp-btn" style="height:100%;">
                                            ...
                                            <div class="row m-t-10" id="send-hoso" style="border-radius: 3px;">
                                                ...
                                                <div v-if="$auth.loggedIn && $auth.user.role != 2 && $auth.user.status == 1" class="col-12 d-flex justify-content-center align-items-center" data-toggle="modal" data-target="#ApplyModal">
                                                ...
                                                <div class="col-12 d-flex justify-content-center align-items-center" >
                                                    <a v-if="$auth.loggedIn && $auth.user.role != 2 && $auth.user.status == 1" class="btn-netbee" style="border-radius: 3px; padding: 5px 0;" data-toggle="modal" data-placement="top" title="Tải đơn hàng" data-target=".bd-example-modal-xl"><i class="fad fa-arrow-alt-to-bottom fa-2x p-10"></i> <b>Tải đơn hàng</b></a>
                                                </div> 
  ...
  validate: value => {
    ...
    if (containsRequiredChars && !containsForbiddenChars) {
      ...
      if (containsForbiddenChars) {
        ...
        " không được chứa số và các ký tự đặc biệt.";
      } else {
        errorMessageinformation =
        //   " phải chứa nhiều hơn 6 ký tự";
          " phải chứa ít nhất 5 ký tự.";
...
export default {
    ...
    computed: {
        slicePath:function() {
            return this.$route.path.slice(7)
        }
    },
    methods: {
        ...
        downloadWithCSS(){  
            this.$swal({
                ...
                showLoaderOnConfirm: true
                    ...
                    if(result.value) {
                       html2canvas(document.querySelector('#ok1'), {scrollX : 0,scrollY : -scrollY,logging: true, letterRendering: true, allowTaint: false, useCORS: true, scale: 1920*2/window.innerWidth}).then(canvas => {
