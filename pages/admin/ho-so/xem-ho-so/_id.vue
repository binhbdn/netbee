                                ...
                                <div style="padding-left:25px;padding-right: 10px;"> 
                                    <div class="briday-cv">
                                        <div class="row">
                                            ...
                                            <div class="col-md-10">
                                                <p class="main-text textarea" v-if="status == 0 && info_frofile_user.form == 0" >Xuất khẩu lao động</p>
                                                <p class="main-text textarea" v-if="status == 0 && info_frofile_user.form == 1" >Du học sinh</p>
                                                <p class="main-text textarea" v-if="status == 0 && info_frofile_user.form == 2" >Tu nghiệp sinh</p>                                                                                                   
                                                <select class="main-select" v-if="status == 1" v-model="info_frofile_user.form">
