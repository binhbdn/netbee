                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-12">
                                                        <div class="form-group">
                                                            ...
                                                            <input id="id-address" type="text" class="form-control" v-model="data.address">
                                                        </div>    
                                                    </div>
                                                    <div class="col-12">
                                                        <ValidationProvider rules="checkSelect" v-slot="{ errors }">
                                                            <div class="form-group">
                                                                ...
                                                                <multiselect id="id-nation" :options="options" v-model="data.nation" :custom-label="nameWithLang" :searchable="true" :allow-empty="false" :show-labels="false" placeholder="Chọn quốc gia"></multiselect>
                                                                <span style="color: red">{{ errors[0] }}</span>
                                                            </div>
                                                        </ValidationProvider>
                                                    </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-6">
                                                        <div class="form-group">
                                                            ...
                                                            <multiselect id="id-academicLevel" :options="levelEx" v-model="data.academicLevel" :custom-label="nameWithLang" :searchable="true" :allow-empty="false" :show-labels="false" placeholder="Chọn trình độ học vấn"></multiselect>
                                                        </div>
                                                    </div>
                                                    <div class="col-sm-6">
                                                    ...
                                                    <div class="col-sm-12">
                                                     ...
                                                     <div class="col-sm-6">
                                                        <div class="form-group">
                                                            <label for="id-visa">Ngành nghề xin visa</label>
                                                            <multiselect id="id-visa" :options="optionsVisa" v-model="data.visa" :custom-label="nameWithVisa" :searchable="true" :allow-empty="false" :show-labels="false" placeholder="Chọn ngành nghê xin visa"></multiselect>                   
                                                        </div>
                                                    </div>
                                                    <div class="col-sm-6">
                                                        <ValidationProvider rules="required|customSoam" v-slot="{ errors }">
                                                    ...
                                                    <div class="col-sm-6">
                                                        <ValidationProvider rules="checkSelect" v-slot="{ errors }">
                                                            <div class="form-group">
                                                                <label for="id-work-form">Hình thức làm việc</label>
                                                                <multiselect id="id-work-form" :options="optionsFormWork" v-model="data.work_form" :custom-label="nameWithLang" :searchable="false" :allow-empty="false" :show-labels="false" placeholder="Chọn hình thức làm việc"></multiselect>
                                                                <span style="color: red">{{ errors[0] }}</span>
                                                            </div>
                                                        </ValidationProvider>
                                                    </div>
                                        ...
                                        <tab-content :before-change="checkValidateStep3" title="Quyền lợi">
                                            <ValidationObserver ref="step3" v-slot="{ valid3 }">
                                                <div class="row">
                                                    <div class="col-12">
                                                        <div class="form-group">
                                                            <label for="id-salary-start">Thu nhập hàng tháng (<span style="color: red;">*</span>)</label>
                                                                <div class="row">
                                                                    <div class="col-sm-6">
                                            ...
                                            <ValidationObserver ref="step4" >
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-6" v-if="checked">
                                                                <div class="form-group">
                                                                    <label for="id-time-bonus">Thời gian thanh toán phí</label>
...
extend("ssdigit", {
    ...
    validate: (value, { target }) => {
        var max = parseFloat(value.replace(/,/gi, ''))
        let min = parseFloat(target.replace(/,/gi, ''))
        if(max >= min){
            return true
        }else{
            return false
