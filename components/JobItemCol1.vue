    ...
    <div class="ecommerce-card border-job-item make-it-sl" style="margin-bottom: 15px;" :class="job.highlight_job ? 'highlight' : ''">
        <div class="card-content h-100">
            ...
            <div class="remove-border-right">
                ...
                <div class="item-name">
                    <a :href="`/cong-ty/${job.id_created}`" class="item-company mb-0"><i class="fad fa-building"></i> <span class="company-name" data-toggle="tooltip" data-placement="top" :title="`${job.user.name}`"> {{ job.user.name }}</span></a>
                </div>
