    ...
    <div class="main-menu menu-fixed menu-light menu-accordion menu-shadow" data-scroll-to-active="true">
        ...
        <div class="main-menu-content">
            <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
                ...
                <li :class="[{'active' : (this.$route.name == 'admin-tai-khoan-ntd-danh-sach') || (this.$route.name == 'admin-tai-khoan-ntd-tao')}, 'nav-item']" v-if="$auth.user.role == 4"><a href="#"><i class="fas fa-briefcase"></i><span class="menu-title" data-i18n="Ecommerce">Quản lý tài khoản</span></a>
                    <ul class="menu-content">
