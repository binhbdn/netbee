        ...
        <div class="card-content h-100">
            ...
            <div class="remove-border-right" style="width: 550px;">
                ...
                <div class="item-quantity row" style="height: 21px">
                    <div class="col-9">
                        <a :href="`/cong-ty/${job.user ? job.user.name : job.id_created}`" class="item-company mb-0"><i class="fad fa-building"></i> <span class="company-name" data-toggle="tooltip" data-placement="top" :title="`${job.nb_company.username}`"> {{ job.nb_company.username }}</span></a>
                    </div>
                    <div class="col-3">
