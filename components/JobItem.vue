    ...
    <div class="ecommerce-card border-job-item make-it-sl" style="margin-bottom: 15px; border-radius: 3px;" :class="job.highlight_job ? 'highlight' : ''">
        <div class="card-content h-100">
            <div class="text-center card-avatar p-1">
                ...
                <a class="delivery-date mb-0 badge border-netbee badge-sm" data-toggle="tooltip" data-placement="top" title="Loại hình tuyển dụng" :class="job.highlight_job ? 'bg-netbee' : ''" style="width: 100px" :href="job.type == 1 ? `/tin-tuyen-sinh/xuat-khau-lao-dong?keyword=&type=1` : job.type == 2 ? `/tin-tuyen-sinh/du-hoc?keyword=&type=2` : `/tin-tuyen-sinh/tu-nghiep-sinh?keyword=&type=3`">
